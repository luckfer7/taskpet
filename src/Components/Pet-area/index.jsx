...
export default function PetArea({ addTask, updateTask, editingTask, clearEditingTask }) {
    ...
    useEffect(() => {
        if (editingTask) setIsTaskFormOpened(true);
    }, [editingTask]);
    ...
    return (
        <Container className="border-4 border-blue-300 rounded-2xl w-sm h-[77%] flex flex-col items-center justify-center gap-3 " >
            ...
            <Button
                onClick={ () => setIsTaskFormOpened(true) }
